...
public interface BeanPostProcessor {
	 ...
	 *
	 * 后置处理器的postProcessorBeforeInitailization方法是在bean实例化，
	 * 依赖注入之后及自定义初始化方法(例如：配置文件中bean标签添加init-method属性指定Java类中初始化方法、
	 * @PostConstruct 注解指定初始化方法，Java类实现 InitailztingBean 接口)之前调用
	 *
	 ...
	 *       在IoC容器继承体系中的ConfigurableBeanFactory接口中定义了注册方法 addBeanPostProcessor
